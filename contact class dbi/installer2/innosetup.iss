...
[Setup]
AppID={{3AEBDC53-6BFF-1014-BC03-9C8CADE64201}
AppName=displayDB
AppVersion=0.0.0.2
AppVerName=displayDB 0.0.0.2
AppPublisher=will
...
LicenseFile=
OutputDir=C:\temp\faz5\installer
...
OutputManifestFile=C:\temp\faz5\installer\innosetup.manifest
InternalCompressLevel=Max
ShowLanguageDialog=no
UninstallDisplayName=displayDB
VersionInfoVersion=0.0.0.2
VersionInfoCompany=will
VersionInfoDescription=displayDB Installer
VersionInfoTextVersion=displayDB Installer 0.0.0.2
VersionInfoCopyright=Copyright (C) 2013 will
VersionInfoProductName=displayDB
...
[Files]
Source: C:\temp\faz5\release\MyApp\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs restartreplace overwritereadonly uninsrestartdelete uninsremovereadonly replacesameversion 32bit; Excludes: do-install.exe; 
Source: C:\temp\faz5\release\MyApp\bin\do-install.exe; DestDir: {app}\bin; Flags: deleteafterinstall skipifsourcedoesntexist 32bit;
...
[Icons]
Name: "{group}\{cm:UninstallProgram,displayDB}"; Filename: "{uninstallexe}"
